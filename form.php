...
define('_EMAIL_TO', 'mr.metayer.enzo@gmail.com');
define('_EMAIL_FROM', 'mr.metayer.enzo@gmail.com');
...
<div class="wrap-embed-contact-form">
	<form class="embed-contact-form">
		<div class="form-heading">Contactez-nous</div>
		<div class="form-sub-heading">
Merci de remplir le formulaire pour nous contacter!</div>
		<hr>
		...
		<div class="form-content">
			<div class="group">
				...
				<div><input id="name" name="name" placeholder="Votre prénom " class="form-control"></div>
			</div>
			<div class="group">
				<label for="email" class="empty"></label>
				<div><input type="email" name="email" placeholder="Votre Email" class="form-control"></div>
			</div>
			<div class="group">
				<label for="query-type">Type de question</label>
				<div>
					<select id="query-type" name="query-type" class="form-control">
						<option value="General Query">Question en général</option>
						<option value="Presale">Question avant achat</option>
						<option value="Technical">Question technique</option>
						<option value="Others">Autres choses</option>
					</select>
				</div>
			</div>
			<div class="group">
				<label for="message" class="empty"></label>
				<div><textarea id="message" name="message" placeholder="Votre Message" class="form-control" rows="5"></textarea></div>
			</div>
			<div class="group">
				<label class="empty"></label>
				<div><button class="btn-submit" type="submit">Envoyer le message</button></div>
			</div>
		</div>
